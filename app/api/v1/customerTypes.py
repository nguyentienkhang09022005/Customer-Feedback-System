...
@router.post("", response_model=APIResponse[CustomerTypeOut])
...
@router.put("/{type_name}", response_model=APIResponse[CustomerTypeOut])
...
@router.delete("/{type_name}", response_model=APIResponse)
